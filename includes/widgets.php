...
class Omi_WPBook_Widget extends WP_Widget {

    // setup the widget name, description, etc...
    public function __construct() {

        $widget_ops = array(
            'classname' => 'omi_wpbook_widget', // html class name
            'description' => __( 'Custom Book Widget for showing books based on their category', 'omi_wpbook' ),
        );

        parent::__construct( 'omi_wpbook_book', 'Books', $widget_ops );
    }
    ...
    public function form( $instance ) {
        ...
        <p><?php esc_html_e('Choose which categories to show', 'omi_wpbook' ); ?>: </p>
